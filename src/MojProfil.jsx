...
<Box  style={{ backgroundColor: 'black', display: 'flex', justifyContent: 'center', height: '100%', width: '100%'}}>
  <div>
<FormControl style={{  width: '60vh', marginTop:'5%' }}>
  <TextField 
   ...
   <TextField 
          ...
          sx={{ height:'50vh'}}
        />
<Button variant="contained" style={{backgroundColor: '#AE2331',marginTop:'10%', marginLeft:'70%', color:'#ffff', borderRadius:'10'}}>UREDI</Button>
</FormControl>
</div>
</Box>
</div>
